        ...
        <div class="modal-dialog modal-basic">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 id="myLargeModalLabel" class="modal-title">{{ Lang::get('tasks.m-delete-task')}}</h4>
                </div>
                <div class="modal-body">

                <form id="form-edit-task" class="form-horizontal" method='post' action='{{url("Delete-Task/$task->encrypted_id")}}' enctype='multipart/form-data'>
                   ...
                   <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        @if(in_array($task_type->id, $types))
                                            <input type="checkbox" name="task_types[]" value="{{$task_type->id}}" checked disabled>{{$task_type->name}}
                                        @else
                                            <input type="checkbox" name="task_types[]" value="{{$task_type->id}}" disabled>{{$task_type->name}}
                                        @endif
                                    </label>
                                </div>
                            @endforeach
                    ...
                    <div class="modal-footer">
                        <center>
                            <h3><i class="fa fa-trash-o"></i>&nbsp;&nbsp;{{ Lang::get('tasks.delete-question')}}</h3>
                        </center>
                    </div>
                    ...
                    <div class="modal-footer">
                        <div id="buttons">
                           ...
                           <input class='btn btn-primary' type="submit" value="{{ Lang::get('tasks.delete')}}">
                        </div>
                        <div id="footer"></div>
                    </div>
                </form>
