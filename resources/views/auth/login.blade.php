        ...
        <div class="row">
            <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
                ...
                <div class="panel panel-default" style="margin-top:50px; padding: 30px 30px 30px 30px;">
                    ...
                    <h3>{{Lang::get('login.login')}}</h3>
                    <p>
                        {{Lang::get('login.credentials')}}
                    </p>
                    <br>
                    
                    <form class="form-login" role="form" action="{{ url('/Log-in') }}" method="post">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-lock"></i> {{Lang::get('login.password')}}</label>
                                <input type="password" class="form-control password" placeholder="{{Lang::get('login.password-ph')}}" name="password">
                            </div>
                            ...
                            <div class="form-actions">
                                ...
                                <br>
                                <br>
                                <a class="pull-left" href="/Reset-User-Password">
                                    {{Lang::get('login.reset')}}
                                </a>
                            </div>
